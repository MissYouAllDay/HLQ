...
@property (weak, nonatomic) IBOutlet UIImageView *backCustomerImg;
@property (weak, nonatomic) IBOutlet UIImageView *shareToFriendsImg;
@property (weak, nonatomic) IBOutlet UIImageView *firstOrderimg;
