...
#import "YPReHomeWebViewController.h"//领取地址
...
-(void)locationClick{
    ...
    YPReHomeWebViewController *webVC = [[YPReHomeWebViewController alloc]initWithUrl:[NSURL URLWithString:[NSString stringWithFormat:@"http://www.chenghunji.com/Map/Index?regionId=%@",areaID]]];//@"http://www.baidu.com"
    NSLog(@"%@",[NSString stringWithFormat:@"http://www.chenghunji.com/Map/Index?regionId=%@",areaID]);
    //http://www.chenghunji.com/Map/Index?regionId=1740
...
- (void)GetDrawQualificationWithType:(NSString *)str{
    ...
    NSString *url = @"/api/User/GetDrawQualification";
...
- (void)PeopleReceivePopcornWithShopID:(NSString *)shopID{
    ...
    NSString *url = @"/api/User/PeopleReceivePopcorn";
...
- (void)PeopleReceiveBigPopcorn{
    ...
    NSString *url = @"/api/User/PeopleReceiveBigPopcorn";
...
- (void)GetAllPrizesList{
    ...
    NSString *url = @"/api/User/GetAllPrizesList";
