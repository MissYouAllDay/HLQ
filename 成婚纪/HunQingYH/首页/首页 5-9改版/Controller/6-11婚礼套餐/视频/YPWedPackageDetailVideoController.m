//
//  YPWedPackageDetailVideoController.m
//  HunQingYH
//
...
#import "YPWedPackageDetailVideoController.h"
#import "WMPlayer.h"
#import "detalVideoCell.h"

@interface YPWedPackageDetailVideoController ()<UITableViewDelegate,UITableViewDataSource,WMPlayerDelegate>
...
@implementation YPWedPackageDetailVideoController{
    UIView *_navView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    YPGetWeddingPackageVideoCaseList *videoModel = self.videoArr[indexPath.row];
...
-(void)toCell{
    detalVideoCell *currentCell = (detalVideoCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:currentIndexPath.row inSection:0]];
...
-(void)startPlayVideo:(UIButton *)sender{
    ...
    YPGetWeddingPackageVideoCaseList *video = self.videoArr[currentIndexPath.row];
...
//        wmPlayer.URLString = self.URLString;
        wmPlayer.URLString = video.VideoId;
