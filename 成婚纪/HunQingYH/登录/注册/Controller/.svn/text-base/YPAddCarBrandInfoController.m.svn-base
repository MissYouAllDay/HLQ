...
#import "YPAddCarBrandInfoController.h"
#import "YPInputNormalCell.h"
#import "YPRegisterImgCell.h"
#import "YPAddCarBrandInfo2Controller.h"

@interface YPAddCarBrandInfoController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UIActionSheetDelegate,ZLPhotoPickerViewControllerDelegate,ZLPhotoPickerBrowserViewControllerDelegate>
...
@implementation YPAddCarBrandInfoController{
    UIView *_navView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        cell.inputTF.placeholder = @"请输入品牌";
...
//    YPAddCarBrandInfo2Controller *addBrand2 = [[YPAddCarBrandInfo2Controller alloc]init];
////    addBrand2.carBrandID = [object valueForKey:@"ModelID"];
//    [self.navigationController pushViewController:addBrand2 animated:YES];
}
...
-(void)AddCarModelWithCarImgID:(NSString *)imgID{
    ...
    params[@"Name"] = self.pinpaiTF.text;
    params[@"CarImg"] = imgID;
    params[@"CarColour"] = @"";
