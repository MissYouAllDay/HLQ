...
-(void)showNoDataEmptyView{
    ...
    [EasyShowEmptyView showEmptyViewWithTitle:@"无数据" subTitle:@"点击重新加载数据！" imageName:@"netError.png" inview:searchTableView callback:^(EasyShowEmptyView *view, UIButton *button, callbackType callbackType) {
        [self GetWebSupplierList];
    }];
