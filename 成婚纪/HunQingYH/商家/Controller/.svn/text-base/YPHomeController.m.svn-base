...
-(void)showNoDataEmptyView{
    ...
    [EasyShowEmptyView showEmptyViewWithTitle:@"无数据" subTitle:@"点击重新加载数据！" imageName:@"netError.png" inview:self.view callback:^(EasyShowEmptyView *view, UIButton *button, callbackType callbackType) {
        [self getGYSList];
    }];
