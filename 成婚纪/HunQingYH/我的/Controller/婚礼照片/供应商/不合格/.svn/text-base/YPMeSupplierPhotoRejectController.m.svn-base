//
//  YPMeSupplierPhotoRejectController.m
//  HunQingYH
//
...
#import "YPMeSupplierPhotoRejectController.h"
#import "YPGetFileSupplierData.h"
#import "YPReToBeCheckDetailImgsCell.h"

@interface YPMeSupplierPhotoRejectController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YPMeSupplierPhotoRejectController{
...
- (void)GetFileSupplier{
    ...
    params[@"Status"]        = @"3";//状态 0全部 1已审核 2未审核 3已驳回 4展示给新人
