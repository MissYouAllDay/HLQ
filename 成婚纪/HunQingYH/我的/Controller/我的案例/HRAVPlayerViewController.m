//
//  HRAVPlayerViewController.m
//  HunQingYH
//
//  Created by DiKai on 2017/11/10.
...
@interface HRAVPlayerViewController ()
...
@implementation HRAVPlayerViewController
...
- (void)viewDidLoad {
    ...
    self.videoTitleLabel.text = _videoTitle;
...
- (void)addPlayer{
    ...
    //创建播放器
    self.asset = [AVAsset assetWithURL:[NSURL URLWithString:_videoUrl]];
    ...
    self.slider.tintColor =MainColor;
