...
- (void)setupUI{
    ...
    NSArray *titleArr = @[@"全部",@"待付款",@"已付款",@"已拒单"];
    NSMutableArray *vcMarr=[NSMutableArray array];
    for (NSString *str in titleArr) {
        YPHotelPayTypeListController *vc = [[YPHotelPayTypeListController alloc]init];
        vc.typeStr = str;
        [vcMarr addObject:vc];
    }
