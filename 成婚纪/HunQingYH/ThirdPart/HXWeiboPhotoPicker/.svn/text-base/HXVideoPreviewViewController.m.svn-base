...
- (void)setup {
    ...
    self.playerLayer.frame = CGRectMake(0, NAVIGATION_BAR_HEIGHT, width, height - NAVIGATION_BAR_HEIGHT);
    ...
    self.playBtn.frame = CGRectMake(0, NAVIGATION_BAR_HEIGHT, width, height - NAVIGATION_BAR_HEIGHT);
