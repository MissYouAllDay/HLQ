...
- (instancetype)initWithFrame:(CGRect)frame loadingStyle:(GKLoadingStyle)loadingStyle {
    if (self = [super initWithFrame:frame]) {
        ...
        self.lineWidth      = 4;
        self.radius         = 24;
        self.GKCHJ_bgColor        = [[UIColor blackColor] colorWithAlphaComponent:0.5];
...
- (CAShapeLayer *)backgroundLayer {
    if (!_backgroundLayer) {
        ...
        _backgroundLayer.strokeColor   = self.GKCHJ_bgColor.CGColor;
...
-(void)setGKCHJ_bgColor:(UIColor *)GKCHJ_bgColor{
    _GKCHJ_bgColor = GKCHJ_bgColor;
    
    self.backgroundLayer.strokeColor = GKCHJ_bgColor.CGColor;
}
