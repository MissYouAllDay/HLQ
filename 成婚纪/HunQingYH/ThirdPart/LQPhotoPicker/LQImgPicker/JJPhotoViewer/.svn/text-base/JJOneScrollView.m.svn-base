...
-(void)setNetWorkImage:(UIImageView *)imageView urlStr:(NSString *)urlStr 
{
    ...
    [UIView animateWithDuration:AnimationTime animations:^{
        ...
        [self.mainImageView sd_setImageWithPreviousCachedImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:self.mainImageView.image options:SDWebImageRetryFailed|SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
...
//         sd_setImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:self.mainImageView.image options:SDWebImageRetryFailed|SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize) {
//
//            NSLog(@"%ld  :  %ld",(long)receivedSize,(long)expectedSize);
//
//            //加载进度条
