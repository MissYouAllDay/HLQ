...
-(void)setFrame:(CGRect)frame{
    ...
    [self.LineView setFrame:CGRectMake(self.bounds.size.width/4-self.bounds.size.width/8, 50, self.bounds.size.width/4, 1)];
}
-(void)initView{
    /*----开始时间---*/
    ...
    self.startTimeTitleLabel.font = [UIFont systemFontOfSize:14.0f];
    ...
    self.startTimeLabel.font = [UIFont fontWithName:@"PingFangSC-Semibold" size:14];
    self.startTimeLabel.textColor = [UIColor colorWithRed:250/255.0 green:80/255.0 blue:120/255.0 alpha:1];
    ...
    self.endTimeTitleLabel.font = [UIFont systemFontOfSize:14.0f];
    ...
    self.endTimeLabel.font = [UIFont fontWithName:@"PingFangSC-Semibold" size:14];
    self.endTimeLabel.textColor = [UIColor colorWithRed:250/255.0 green:80/255.0 blue:120/255.0 alpha:1];
    ...
    self.LineView.backgroundColor = [UIColor colorWithRed:250/255.0 green:80/255.0 blue:120/255.0 alpha:1];
...
-(void)startTimeTapAction{
    [UIView animateWithDuration:0.3 animations:^{
        self.LineView.frame = CGRectMake(self.bounds.size.width/4-self.bounds.size.width/8, 50, self.bounds.size.width/4, 1);
    }];
...
-(void)endTimeTapAction{
    [UIView animateWithDuration:0.3 animations:^{
        self.LineView.frame=CGRectMake(self.bounds.size.width/2+self.bounds.size.width/8, 50, self.bounds.size.width/4, 1);
    }];
