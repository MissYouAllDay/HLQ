...
-(void)creatSubviews{
    ...
    countryCodeTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NAVIGATION_BAR_HEIGHT, self.view.bounds.size.width, self.view.bounds.size.height-NAVIGATION_BAR_HEIGHT) style:UITableViewStylePlain];
