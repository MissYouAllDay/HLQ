//
//  YPHYTHOrderListRestPayCountCell.m
//  HunQingYH
//
...
@implementation YPHYTHOrderListRestPayCountCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    
    static NSString *reusedID = @"YPHYTHOrderListRestPayCountCell";
    YPHYTHOrderListRestPayCountCell *cell = [tableView dequeueReusableCellWithIdentifier:reusedID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"YPHYTHOrderListRestPayCountCell" owner:nil options:nil] lastObject];
    }
    return cell;
