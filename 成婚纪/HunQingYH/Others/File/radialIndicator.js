...
;(function (factory) {
    ...
    Indicator.prototype = {
        ...
        _drawBarBg: function() {
            ...
            ctx.strokeStyle = indOption.barCHJ_bgColor; //background circle color
            ctx.lineWidth = indOption.barWidth;
            if (indOption.barCHJ_bgColor != "transparent") {
                ctx.beginPath();
        ...
        option: function(key, val) {
            ...
            if (['radius', 'barWidth', 'barCHJ_bgColor', 'format', 'maxValue', 'percentage'].indexOf(key) != -1) {
    ...
    radialIndicator.defaults = {
        ...
        barCHJ_bgColor: '#eeeeee', //unfilled bar color
