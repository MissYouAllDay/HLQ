...
- (void)layoutSubviews
{
    ...
    if(self.firstIndex != 0){
        [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:self.firstIndex-1 inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:NO];
    }
}
