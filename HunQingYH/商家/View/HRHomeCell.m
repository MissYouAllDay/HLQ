...
-(void)setModel:(YPGetWebSupplierList *)model{
    _model =model;
    [_photoImageView sd_setImageWithURL:[NSURL URLWithString:model.ImgUrl]placeholderImage:[UIImage imageNamed:@"占位图"]];
    _nameLab.text =model.Name;
    _numLab.text =[NSString stringWithFormat:@"案例  %@",model.CaseCount];
