...
@interface YPSupplierOtherInfoController ()<TYSlidePageScrollViewDataSource,TYSlidePageScrollViewDelegate>
{
...
- (void)addTabPageMenu
{
    TYTitlePageTabBar *titlePageTabBar = [[TYTitlePageTabBar alloc]initWithTitleArray:@[@"简介",@"动态"]];
...
- (void)addTableView{
    ...
    if (!self.ctrl4) {
        self.ctrl4 = [[YPHotelDongTaiTableViewController alloc] initWithStyle:UITableViewStylePlain];
