...
-(void)timeBtnClick{
    //婚期
    [BRDatePickerView showDatePickerWithTitle:@"请选择婚期" dateType:UIDatePickerModeDate defaultSelValue:@"" minDateStr:@"" maxDateStr:@"" isAutoSelect:YES resultBlock:^(NSString *selectValue) {
...
//
//    [EasyShowEmptyView showEmptyViewWithTitle:@"无数据" subTitle:@"点击重新加载数据！" imageName:@"netError.png" inview:thistableView callback:^(EasyShowEmptyView *view, UIButton *button, callbackType callbackType) {
//        [self GetWebSupplierList];
//    }];
//
//}
