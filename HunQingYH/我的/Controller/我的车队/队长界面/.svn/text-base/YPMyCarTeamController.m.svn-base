...
#import "YPMyCarEditJianJieController.h"//修改简介
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if (buttonIndex == 0) {
        ...
        YPMyCarEditJianJieController *edit = [[YPMyCarEditJianJieController alloc]init];
...
- (void)DirverPull{
    ...
    params[@"SupplierID"] = FacilitatorId_New;//队长解散车队
    params[@"UserID"] = UserId_New;
    params[@"Start"] = @"1";//0车手退出、1队长解散
    ...
    [[NetworkTool shareManager] requestWithUrlStr:url withParams:params Success:^(NSDictionary *object) {
        ...
        if ([[[object valueForKey:@"Message"] valueForKey:@"Code"] integerValue] == 200) {
            ...
            [EasyShowTextView showSuccessText:@"解散成功!"];
            
            //供应商ID 置空
            [[NSUserDefaults standardUserDefaults] setObject:nil forKey:@"SupplierID"];
            //队长解散车队后 职业改为 车手
            [[NSUserDefaults standardUserDefaults] setObject:CheShou_New forKey:@"Profession"];
