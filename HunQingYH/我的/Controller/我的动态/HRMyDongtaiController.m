//
//  HRMyDongtaiController.m
//  HunQingYH
//
//  Created by Hiro on 2018/5/23.
...
@interface HRMyDongtaiController ()<UICollectionViewDelegate,UICollectionViewDataSource>{
    NSInteger PageIndex;
...
@implementation HRMyDongtaiController
