...
@implementation YPReMyWalletBankListCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    
    static NSString *reusedID = @"YPReMyWalletBankListCell";
    YPReMyWalletBankListCell *cell = [tableView dequeueReusableCellWithIdentifier:reusedID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"YPReMyWalletBankListCell" owner:nil options:nil] lastObject];
    }
    return cell;
