//
//  YPWeddingOrderSupplierListController.m
//  HunQingYH
//
...
#import "YPWeddingOrderSupplierListController.h"
#import "SearchView.h"
#import "HRGYSModel.h"
//#import "HRHomeCell.h"
//6-4 替换
...
@interface YPWeddingOrderSupplierListController()<SearchViewDelegate,SearchViewDataSource,UITableViewDelegate,UITableViewDataSource>{
...
@implementation YPWeddingOrderSupplierListController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.supBlock) {
        self.supBlock(gysModel.Name, gysModel.Id);
        [self.navigationController popViewControllerAnimated:YES];
    }
