...
@interface HRTextView()<UITextViewDelegate,UIScrollViewDelegate>
{
    BOOL statusTextView;//当文字大于限定高度之后的状态
    NSString *placeholderText;//设置占位图符的文字
}
...
- (void)sendClick:(UIButton *)sender{
    ...
    if (self.HRTextViewBlock) {
        self.HRTextViewBlock(self.textView.text);
    }
