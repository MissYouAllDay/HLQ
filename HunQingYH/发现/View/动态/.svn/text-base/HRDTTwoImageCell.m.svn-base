...
@implementation HRDTTwoImageCell
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    
    static NSString *reusedID = @"HRDTTwoImageCell";
    HRDTTwoImageCell *cell = [tableView dequeueReusableCellWithIdentifier:reusedID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"HRDTTwoImageCell" owner:nil options:nil] lastObject];
    }
