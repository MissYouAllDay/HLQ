...
@interface HRDongTaiViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,LMHWaterFallLayoutDeleaget>{
    NSInteger PageIndex;
...
- (CGFloat)waterFallLayout:(LMHWaterFallLayout *)waterFallLayout heightForItemAtIndexPath:(NSUInteger)indexPath itemWidth:(CGFloat)itemWidth{
    ...
    HRDongTaiModel *model = self.dtArray[indexPath];
    NSString *str = model.CoverImg;
    /**
     *  参数1:图片URL
     *  参数2:imageView 宽度
