...
#import "YPMyNewWedsManThemeController.h"//婚礼主题
#import "YPGetNewPeopleQuestionListDataXR.h"//新人模型
#import "YPGetNewPeopleInfo.h"//个人信息

@interface YPMyNewWedsManController ()<UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,YPMyNewlywedsAddPersonInfoDelegate,YPNewWedsOtherInfoDelegate,YPNewWedsOtherSelectDelegate>
...
@implementation YPMyNewWedsManController
    ...
    if (self.upState == 1) {//已提交 不能修改
        ...
        if (indexPath.section == 0) {
            ...
            if (data.OptionAnswer.length > 0 || data.Answer.length > 0) {
                ...
                if ([data.TypeQuestion integerValue] == 0) {//0填写,1选择
                ...
                }else if ([data.TypeQuestion integerValue] == 1) {//0填写,1选择
                    ...
                    select.selectTypeStr = data.TypeContent;
...
//
//    if (actionSheet.tag > 2000) {//edit编辑
//
//        YPGetNewPeopleQuestionListDataXR *data = self.xrDataList[actionSheet.tag - 2001 -1];
//        NSArray *arr = [data.TypeContent componentsSeparatedByString:@","];
...
//    if ([data.QuestionClassification isEqualToString:@"婚礼主题"]){
//        //主题
//
//        YPMyNewWedsManThemeController *theme = [[YPMyNewWedsManThemeController alloc]init];
