...
- (id)initWithReuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        [bgButton setTitleColor:BlackColor forState:UIControlStateNormal];
...
//        bgButton.titleEdgeInsets = UIEdgeInsetsMake(0, 10, 0, 0);
        bgButton.contentEdgeInsets = UIEdgeInsetsMake(30, ScreenWidth-30, 30, 0);
        bgButton.titleEdgeInsets = UIEdgeInsetsMake(0, -ScreenWidth+30, 0, 50);
        bgButton.backgroundColor =WhiteColor;
