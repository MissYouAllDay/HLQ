//
//  YPWedPackageDetailPhotoListCell.m
//  HunQingYH
//
...
@interface YPWedPackageDetailPhotoListCell()

@property (nonatomic,strong) UIActivityIndicatorView *indicatorView;

@end

@implementation YPWedPackageDetailPhotoListCell{
...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    static NSString *reusedID = @"YPWedPackageDetailPhotoListCell";
    YPWedPackageDetailPhotoListCell *cell = [tableView dequeueReusableCellWithIdentifier:reusedID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"YPWedPackageDetailPhotoListCell" owner:nil options:nil] lastObject];
    }
    return cell;
...
- (void)oneImgTap{
    ...
    [UIView animateWithDuration:0.3f
                     ...
                     animations:^{
                         ...
                         [self.superview.superview addSubview:_backView];
...
- (void)dismissBigImage{
    ...
    CGRect oneImgBtnFrame = _iconImgV.frame;
