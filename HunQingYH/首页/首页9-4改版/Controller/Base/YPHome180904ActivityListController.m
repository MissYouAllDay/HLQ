//
//  YPHome180904ActivityListController.m
//  HunQingYH
//
...
#import "YPHome180904ActivityListController.h"
...
@interface YPHome180904ActivityListController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
...
@implementation YPHome180904ActivityListController{
    UIView *_navView;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.iconImgV.layer.cornerRadius = 4;
    cell.iconImgV.clipsToBounds = YES;
    return cell;
    
}

- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return (ScreenWidth-36)*0.5+20;
}
...
//        [self.navigationController pushViewController:yqjh animated:YES];
    ...
    }else if ([listModel.ActivityCode isEqualToString:@"BSL"]){//伴手礼 18-09-17
    ...
    }else if ([listModel.ActivityCode isEqualToString:@"DS"]){//代收 18-09-17
