...
- (void)setUrlArr:(NSArray *)urlArr{
    ...
    if (!self.scrollView) {
        self.scrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(10, 10, ScreenWidth-20, (ScreenWidth-20)*0.38) imageURLStringsGroup:_urlArr];
...
- (void)setImgArr:(NSArray *)imgArr{
    ...
    if (!self.scrollView) {
        self.scrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(10, 10, ScreenWidth-20, (ScreenWidth-20)*0.5) imageNamesGroup:_imgArr];
        self.scrollView.currentPageDotColor = NavBarColor;
        self.scrollView.pageDotColor = WhiteColor;
    }
    [self.contentView addSubview:self.scrollView];
