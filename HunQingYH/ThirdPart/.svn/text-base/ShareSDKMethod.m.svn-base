...
+(void)ShareTextActionWithTitle:(NSString*)title ShareContent:(NSString*)content ShareUlr:(NSString*)url shareImage:(NSString *)ImageUrl IsCollect:(BOOL)isCollect IsReport:(BOOL)isReport IsCollected:(BOOL)isCollected Report:(ReportBlock)reportBlock Collect:(CollectBlock)collectBlock Result:(ResultBlock)resultBlock withDes1:(NSString *)des1 withDes2:(NSString *)des2
{
    //设置分享参数
...
//    UIImage *iconImage =Image;
    ...
    //QQ
    [_shareParams SSDKSetupQQParamsByText:content title:title url:[NSURL URLWithString:url] thumbImage:nil image:imgUrl type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeQQFriend];
    
    //微信朋友圈
    [_shareParams SSDKSetupWeChatParamsByText:content title:title url:[NSURL URLWithString:url] thumbImage:nil image:imgUrl musicFileURL:nil extInfo:nil fileData:nil emoticonData:nil type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeWechatTimeline];
    //微信

 ///暂时缩略图为本地的，换网络图不显示问题未解决
    [_shareParams SSDKSetupWeChatParamsByText:content title:title url:[NSURL URLWithString:url] thumbImage: [UIImage imageNamed:@"分享图标"] image:nil musicFileURL:nil extInfo:nil fileData:nil emoticonData:nil type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeWechatSession];
    //空间
    [_shareParams SSDKSetupQQParamsByText:title title:title url:[NSURL URLWithString:url] thumbImage:nil image:imgUrl type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeQZone];
    //微博
    [_shareParams SSDKSetupSinaWeiboShareParamsByText:[NSString stringWithFormat:@"%@%@",title,url] title:title image:imgUrl url:[NSURL URLWithString:url] latitude:0 longitude:0 objectID:nil type:SSDKContentTypeAuto];
    //创建UI
    [self createCustomUIWithCollect:isCollect Report:isReport withDes1:des1 withDes2:des2];
}
//自定义分享UI
+(void)createCustomUIWithCollect:(BOOL)isCollect Report:(BOOL)isReport withDes1:(NSString *)des1 withDes2:(NSString*)des2
{
    ...
    //提示话
    UILabel *lab1 = [[UILabel alloc]initWithFrame:CGRectMake(0, ScreenHeight-220, ScreenWidth, 50)];
    lab1.textColor =WhiteColor;
    lab1.textAlignment =NSTextAlignmentCenter;
    lab1.text =des1;
    [grayView addSubview:lab1];
    
    UILabel *lab2 = [[UILabel alloc]initWithFrame:CGRectMake(0, ScreenHeight-180, ScreenWidth, 50)];
    lab2.textColor =WhiteColor;
    lab2.textAlignment =NSTextAlignmentCenter;
    lab2.text =des2;
    [grayView addSubview:lab2];
...
//    NSArray *imageNameArr = @[@"share_qq",@"share_weichat_zone",@"share_weichat",@"share_zone",@"share_weibo"];
      NSArray *imageNameArr = @[@"share_weichat_zone",@"share_weichat"];
    NSMutableArray *imagesArr = [NSMutableArray array];
    for (NSString *imageName in imageNameArr) {
        UIImage *image = [UIImage imageNamed:imageName];
        [imagesArr addObject:image];
    }
    NSArray *titlesArr = @[@"朋友圈",@"微信好友"];
