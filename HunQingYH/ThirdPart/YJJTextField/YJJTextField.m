...
- (IBAction)textFieldEditingChanged:(UITextField *)sender
{
    ...
    self.textLengthLabel.text = [NSString stringWithFormat:@"%lu/%zd",sender.text.length,self.maxLength];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.textLengthLabel.text = [NSString stringWithFormat:@"%lu/%zd",self.textField.text.length,self.maxLength];
