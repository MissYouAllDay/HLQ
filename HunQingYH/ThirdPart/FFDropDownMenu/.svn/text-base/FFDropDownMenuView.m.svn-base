...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.triangleY = NAVIGATION_BAR_HEIGHT+50;
        self.realTriangleY = self.triangleY;
        self.triangleRightMargin = 20;
        self.triangleSize = CGSizeMake(18, 10);
        self.CHJ_bgColorbeginAlpha = 0.02;
        self.CHJ_bgColorEndAlpha = 0.2;
...
- (void)setup {
    ...
    self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:self.CHJ_bgColorEndAlpha];
...
- (void)dismissMenuWithAnimation:(BOOL)animation {
    ...
    if (animation == YES) {
        ...
        if (self.menuAnimateType == FFDropDownMenuViewAnimateType_FadeInFadeOut) {
            [UIView animateWithDuration:self.animateDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                weakSelf.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:self.CHJ_bgColorbeginAlpha];
        ...
        //============
            ...
            [UIView animateWithDuration:self.animateDuration animations:^{
                ...
                weakSelf.backgroundColor = FFColor(0, 0, 0, weakSelf.CHJ_bgColorbeginAlpha);
            } completion:^(BOOL finished) {
                [weakSelf removeFromSuperview];
            }];
        ...
        //=============
            ...
            [UIView animateWithDuration:self.animateDuration animations:^{
                ...
                weakSelf.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:weakSelf.CHJ_bgColorbeginAlpha];
                weakSelf.tableView.alpha = 0;
                weakSelf.triangleView.alpha = 0;
    ...
    //================================
        ...
        if (self.menuAnimateType == FFDropDownMenuViewAnimateType_FadeInFadeOut) {
            self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:self.CHJ_bgColorbeginAlpha];
            [self removeFromSuperview];
        }
...
- (void)showMenu {
    ...
    //将背景颜色设置浅的背景颜色
    self.backgroundColor = FFColor(0, 0, 0, self.CHJ_bgColorbeginAlpha);
    __weak typeof(self) weakSelf = self;
    ...
    if (self.menuAnimateType == FFDropDownMenuViewAnimateType_FadeInFadeOut) {
        ...
        [UIView animateWithDuration:self.animateDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            weakSelf.backgroundColor = FFColor(0, 0, 0, self.CHJ_bgColorEndAlpha);
    ...
    //=============
        ...
        [UIView animateWithDuration:self.animateDuration animations:^{
            ...
            weakSelf.backgroundColor = FFColor(0, 0, 0, weakSelf.CHJ_bgColorEndAlpha);
        } completion:^(BOOL finished) {
            [weakSelf menuDidShow];
        }];
    }
    ...
    //============
        ...
        [UIView animateWithDuration:self.animateDuration animations:^{
            weakSelf.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:self.CHJ_bgColorEndAlpha];
...
- (void)setCHJ_bgColorbeginAlpha:(CGFloat)CHJ_bgColorbeginAlpha {//12
    if (CHJ_bgColorbeginAlpha != FFDefaultFloat) {
        _CHJ_bgColorbeginAlpha = CHJ_bgColorbeginAlpha;
    }
}

- (void)setCHJ_bgColorEndAlpha:(CGFloat)CHJ_bgColorEndAlpha {//13
    if (CHJ_bgColorEndAlpha != FFDefaultFloat) {
        _CHJ_bgColorEndAlpha = CHJ_bgColorEndAlpha;
    }
}
