...
- (UINavigationBar *)navBar {
    if (!_navBar) {
        ...
        _navBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0, 0, width, NAVIGATION_BAR_HEIGHT)];
...
- (void)setup {
    ...
    flowLayout.itemSize = CGSizeMake(width, height - NAVIGATION_BAR_HEIGHT);
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(-10, NAVIGATION_BAR_HEIGHT, width + 20, height - NAVIGATION_BAR_HEIGHT) collectionViewLayout:flowLayout];
