...
- (instancetype)dh_initWithFrame:(CGRect)frame imageNameArray:(NSArray<NSString *> *)imageNameArray buttonIsHidden:(BOOL)isHidden {
    if ([super initWithFrame:frame]) {
        ...
        self.imagePageControl.currentPageIndicatorTintColor = MainColor;
...
- (instancetype)dh_initWithFrame:(CGRect)frame videoURL:(NSURL *)videoURL {
    if ([super initWithFrame:frame]) {
        ...
        self.playerController.backgroundView.backgroundColor = WhiteColor;
        self.playerController.view.backgroundColor = WhiteColor;
        ...
        [self.playerController setRepeatMode:MPMovieRepeatModeNone];
        [self.playerController setShouldAutoplay:YES];
        [self.playerController prepareToPlay];
        [self addSubview:self.playerController.view];
        
        // 视频引导页进入按钮
        UIButton *movieStartButton = [[UIButton alloc] initWithFrame:CGRectMake(50, DDScreenH-70-40-HOME_INDICATOR_HEIGHT, DDScreenW-100, 40)];
        [movieStartButton.layer setCornerRadius:20.0];
        movieStartButton.clipsToBounds = YES;
        [movieStartButton setTitle:@"立即体验" forState:UIControlStateNormal];
        [movieStartButton setTitleColor:WhiteColor forState:UIControlStateNormal];
        [movieStartButton setBackgroundImage:[UIImage gradientImageWithBounds:movieStartButton.frame andColors:@[[UIColor colorWithRed:249/255.0 green:35/255.0 blue:123/255.0 alpha:1.0],[UIColor colorWithRed:248/255.0 green:99/255.0 blue:103/255.0 alpha:1.0]] andGradientType:1] forState:UIControlStateNormal];
        [movieStartButton setBackgroundImage:[UIImage gradientImageWithBounds:movieStartButton.frame andColors:@[[UIColor colorWithRed:249/255.0 green:35/255.0 blue:123/255.0 alpha:1.0],[UIColor colorWithRed:248/255.0 green:99/255.0 blue:103/255.0 alpha:1.0]] andGradientType:1] forState:UIControlStateHighlighted];
