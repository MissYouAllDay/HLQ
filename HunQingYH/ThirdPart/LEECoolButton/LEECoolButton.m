...
//    return button;
//}
+ (id)coolButtonWithImage:(UIImage *)image ImageFrame:(CGRect)imageFrame WithTitle:(NSString *)Title TitleColor:(UIColor *)Color{
...
- (void)setSelected:(BOOL)selected{
    ...
    if (isEqual) {
        ...
        if (selected){
            ...
            [self setTitleColor:self.imageColorOn forState:UIControlStateNormal];
        } else {
...
- (void)deselect{
    ...
    for (CAShapeLayer *line in self.lineArray) {
     ...
     [self setTitleColor:self.imageColorOff forState:UIControlStateNormal];
}
