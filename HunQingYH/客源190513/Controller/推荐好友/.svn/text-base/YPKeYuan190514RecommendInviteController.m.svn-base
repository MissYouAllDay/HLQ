//
//  YPKeYuan190514RecommendInviteController.m
//  HunQingYH
//
...
@interface YPKeYuan190514RecommendInviteController ()<UITableViewDelegate,UITableViewDataSource,CJAreaPickerDelegate>
...
@implementation YPKeYuan190514RecommendInviteController{
    //数据库
    FMDatabase *dataBase;
    UIView *_navView;
    NSInteger _select;
...
- (void)setupNav{
    ...
    [record setTitle:@"邀请记录" forState:UIControlStateNormal];
    [record setTitleColor:WhiteColor forState:UIControlStateNormal];
    [record setBackgroundColor:[UIColor colorWithWhite:0.0 alpha:0.5]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        ...
        UIImageView *imgV = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"keyuan190514_invite"]];
...
- (void)recordClick{
    YPKeYuan190521MyPublishController *record = [[YPKeYuan190521MyPublishController alloc]init];
    record.type = 2;
...
- (void)CeaterInvitationRecord{
    ...
    [[NetworkTool shareManager] requestWithUrlStr:url withParams:params Success:^(NSDictionary *object) {
        ...
        if ([[[object valueForKey:@"Message"] valueForKey:@"Code"] integerValue] == 200) {
            ...
            [EasyShowTextView showSuccessText:@"邀请成功!" inView:self.tableView];
