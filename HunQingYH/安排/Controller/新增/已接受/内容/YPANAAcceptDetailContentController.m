//
//  YPANAAcceptDetailContentController.m
//  HunQingYH
//
...
@interface YPANAAcceptDetailContentController ()<ZJScrollPageViewChildVcDelegate,UITableViewDelegate,UITableViewDataSource,YPAddRemarkDelegate>
...
@implementation YPANAAcceptDetailContentController{
    //避免重复创建
    UIView *view;
    UIButton *deleteBtn;
    UIButton *editBtn;
        ...
        if (self.liuchengMarr.count > 0) {//有流程
            ...
            if (self.remark.length > 0) {
                ...
                if (indexPath.row == self.liuchengMarr.count) {
                    YPTextNormalCell *textCell = [YPTextNormalCell cellWithTableView:tableView];
                    textCell.accessoryType = UITableViewCellAccessoryNone;
                    textCell.selectionStyle = UITableViewCellSelectionStyleNone;
                    textCell.titleLabel.text = @"备注";
                    textCell.content.text = self.remark;
                    return cell;
                }
            }
