//
//  YPAddCarBrandInfo2Controller.m
//  HunQingYH
//
...
@interface YPAddCarBrandInfo2Controller ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UIActionSheetDelegate,ZLPhotoPickerViewControllerDelegate,ZLPhotoPickerBrowserViewControllerDelegate>
...
@implementation YPAddCarBrandInfo2Controller{
    UIView *_navView;
...
-(void)AddCarModelWithCarImgID:(NSString *)imgID{
    ...
    [[NetworkTool shareManager] requestWithUrlStr:url withParams:params Success:^(NSDictionary *object) {
        ...
        if ([[[object valueForKey:@"Message"] valueForKey:@"Code"] integerValue] == 200) {
            ...
            NSLog(@"AddCarModel22222 ---- success");
            
            UIViewController *mineVC = nil;
            for (UIViewController * controller in self.navigationController.viewControllers) {
                //遍历
                if([controller isKindOfClass:[YPCarBrandController class]]){
                    //这里判断是否为你想要跳转的页面
                    mineVC = controller;
                    break;
                }
